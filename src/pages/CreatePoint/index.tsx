...
const CreatePoint = () => {
  ...
  const [selectedPosisiton, setSelectedPosisiton] = useState<[number, number]>([
    0,
    0,
  ]);
  ...
  function handleMapClick(event: LeafletMouseEvent) {
    setSelectedPosisiton([event.latlng.lat, event.latlng.lng]);
  }
      ...
      <div className="wrapper-save">
        <div className="success-box">
          <div className="box-icon">
            <FiCheckCircle size={32} color="#34CB79" />
          </div>
          <h2>Cadastro Concuído</h2>
        </div>
      </div>
    );
  }
